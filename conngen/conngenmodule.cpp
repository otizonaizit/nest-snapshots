...
namespace nest
{
  ...
  /* BeginDocumentation
     Name: CGConnect - Call start() on a ConnectionGenerator
     ...
     SeeAlso: Connect, synapsedict, GetOptions, CGParse, CGSelectImplementation, cgstart, cgnext, cgsetmask
  */
  ...
  /* BeginDocumentation
     ...
     SeeAlso: cgstart, cgnext, CGConnect, CGParse, CGSelectImplementation
  */  
  ...
  /* BeginDocumentation
     ...
     SeeAlso: cgnext, cgsetmask, CGConnect, CGSelectImplementation
  */  
  ...
  /* BeginDocumentation
     ...
     Author: Jochen Martin Eppler
     FirstVersion: September 2013
     SeeAlso: cgnext, cgsetmask, CGConnect, CGParse
  */  
  ...
  /* BeginDocumentation
     ...
     Author: Mikael Djurfeldt
     FirstVersion: March 2011
     SeeAlso: cgnext, cgsetmask, CGConnect, CGParse, CGSelectImplementation
  */  
  ...
  /* BeginDocumentation
     ...
     SeeAlso: cgstart, cgsetmask, CGConnect, CGParse, CGSelectImplementation
  */  
